...
MODULE_DESCRIPTION("Neuron Driver, built from SHA: eb811ada530e1dd53b291e789844835ae2c6ab00");
MODULE_LICENSE("GPL");
MODULE_VERSION("2.x.6781.0");
MODULE_ALIAS("pci:v00001d0fd00007064sv*sd*bc*sc*i*");

const char driver_version[] = "2.x.6781.0";
const char driver_revision[] = "eb811ada530e1dd53b291e789844835ae2c6ab00";
