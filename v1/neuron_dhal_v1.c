 ...
 * @return int: 0 on success, -1 on failure
 */
static int fw_io_execute_request_v1(struct fw_io_ctx *ctx, u8 command_id, const u8 *req, u32 req_size, u8 *resp, u32 resp_size)
{
 ...
 * @return int: 0 on success, -1 on failure
 */
static int fw_io_post_metric_v1(struct fw_io_ctx *ctx, u8 *data, u32 size)
{
...
int ndhal_register_funcs_v1(void) {
	...
	ndhal->ndhal_fw_io.fw_io_execute_request = fw_io_execute_request_v1;
	ndhal->ndhal_fw_io.fw_io_post_metric = fw_io_post_metric_v1;
